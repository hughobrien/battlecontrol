...
python3 scripts/ra/ra-nocd-patch.py ./RA95_patched.EXE
printf '\x00' | dd of=./RA95_patched.EXE bs=1 seek=$((0x1BFCB7)) conv=notrunc  # CD1 label zero
python3 scripts/ra/ra-vqa-skip-patch.py ./RA95_patched.EXE
```
(`ra-focus-skip-patch.py` and `ra-game-in-focus-patch.py` are for the AUTODEMO
