/*
 * TIM-747 — Capture the "Command & Conquer" window from inside Wine via BitBlt.
 *
 * Why this exists:
 *   On Wine 11.x, TD.s DirectDraw primary surface is created by wined3d
 ...
 *
 * Output:
 *   24-bit BMP of the "Command & Conquer" client area, or of the desktop if the
...
int main(int argc, char **argv) {
    ...
    HWND hwnd = FindWindowA(NULL, "Command & Conquer");
    if (!hwnd) {
