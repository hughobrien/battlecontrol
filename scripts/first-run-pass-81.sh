#!/usr/bin/env bash
# TIM-289 pass-81: diagnose simulation freeze — target acquisition vs pathfinding
#
...
#
# Run from repo root:
#   bash scripts/first-run-pass-81.sh
...
PASS_DIR="$REPO_ROOT/build/first-run-pass-81"
