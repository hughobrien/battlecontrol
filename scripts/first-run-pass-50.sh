#!/usr/bin/env bash
# TIM-202 pass-50: incremental rebuild + extended run — trace Init_Game milestones.
#
# Delta vs pass-49:
#   INIT.CPP:    debug fprintf around Init_Secondary_Mixfiles, Play_Intro,
#                Init_Color_Remaps, Load_Title_Page, Init_Bulk_Data milestones
#   MIXFILE.CPP: full index dump for GENERAL.MIX, LORES.MIX, CONQUER.MIX
#
# Goal: determine which Init_Game milestone we reach and diagnose TITLE.PCX loop.
#
# Run from repo root:
#   bash scripts/first-run-pass-50.sh
...
PASS_DIR="$REPO_ROOT/build/first-run-pass-50"
