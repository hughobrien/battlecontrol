...
#   - TIM-53 fix 1: linux/win32-stubs/msvc-compat.h gains the MSVC
...
#   - TIM-53 fix 2: linux/win32-stubs/windows.h gains UCHAR (wsnwlink
...
#   - TIM-53 fix 3: linux/win32-stubs/winsock.h gains htons / htonl /
...
#   - TIM-53 fix 4: linux/win32-stubs/share.h is populated with the
...
#   pass 26 (TIM-51)                      : 184
#   pass 27 (TIM-52)                      : 184
#   pass 28 (TIM-53, this run)            : ?
#
# Measurement only -- source fixes live in TIM-53.
...
LOG_FILE="$LOG_DIR/first-compile-pass28.log"
SUMMARY_FILE="$LOG_DIR/first-compile-pass28.summary.txt"
ATTRIB_FILE="$LOG_DIR/first-compile-pass28.attribution.txt"
...
{
    echo "# TIM-53 first compile attempt -- pass 28 (post TIM-53 bundle-mode shim sweep)"
    echo "# host: $(uname -srm)"
