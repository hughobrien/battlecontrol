#!/usr/bin/env bash
# TIM-157 verification: first-link-pass-157 (pass-48) — SDL2 surface/render layer.
#
...
PASS_DIR="$REPO_ROOT/build/first-link-pass-157"
...
{
    echo "# TIM-157 first-link-pass-157 compile-to-object stage"
    echo "# host: $(uname -srm)"
...
{
    echo "# TIM-157 first-link-pass-157 (pass-48) link summary"
    echo "# date: $(date -Is)"
