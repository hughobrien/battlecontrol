#!/usr/bin/env bash
# TIM-142 measurement: pass 43C (wire SDL_Quit_Requested() into
...
LOG_FILE="$LOG_DIR/first-compile-pass43C.log"
SUMMARY_FILE="$LOG_DIR/first-compile-pass43C.summary.txt"
ATTRIB_FILE="$LOG_DIR/first-compile-pass43C.attribution.txt"
...
{
    echo "# TIM-142 first compile attempt -- pass 43C (wire SDL_Quit_Requested() into Main_Loop)"
    echo "# host: $(uname -srm)"
