#!/usr/bin/env bash
# TIM-154 verification: first-link-pass-154 — umbrella-A NOP stubs.
#
...
PASS_DIR="$REPO_ROOT/build/first-link-pass-154"
...
{
    echo "# TIM-154 first-link-pass-154 compile-to-object stage"
    echo "# host: $(uname -srm)"
...
{
    echo "# TIM-154 first-link-pass-154 link summary"
    echo "# date: $(date -Is)"
    ...
    echo "delta vs pass-151: $(( 155 - undef_count )) (closed by TIM-154)"
    echo "#"
