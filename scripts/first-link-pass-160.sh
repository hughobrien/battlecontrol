#!/usr/bin/env bash
# TIM-160 verification: first-link-pass-160 (pass-160) — SDL2 surface/render layer.
#
...
PASS_DIR="$REPO_ROOT/build/first-link-pass-160"
...
{
    echo "# TIM-160 first-link-pass-160 compile-to-object stage"
    echo "# host: $(uname -srm)"
...
{
    echo "# TIM-160 first-link-pass-160 (pass-160) link summary"
    echo "# date: $(date -Is)"
