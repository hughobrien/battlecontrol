#!/usr/bin/env bash
# TIM-206 pass-58: RA_AUTOSTART pre-loop bypass — skip menu in headless test
#
# Delta from pass-57:
#   INIT.CPP: RA_AUTOSTART bypass moved before while(process) — no click needed
#
# Expected:
...
#
# Run from repo root:
#   bash scripts/first-run-pass-58.sh

set -u

REPO_ROOT="$(cd "$(dirname "$0")/.." && pwd)"
SRC_DIR="$REPO_ROOT/REDALERT"
SHIM_DIR="$REPO_ROOT/build/include-shim-pass-58"
STUB_DIR="$REPO_ROOT/linux/win32-stubs"
PASS_DIR="$REPO_ROOT/build/first-run-pass-58"
