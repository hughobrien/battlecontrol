#!/usr/bin/env bash
# TIM-142 measurement: pass 42A (wire SDL_Quit_Requested() into
...
LOG_FILE="$LOG_DIR/first-compile-pass42A.log"
SUMMARY_FILE="$LOG_DIR/first-compile-pass42A.summary.txt"
ATTRIB_FILE="$LOG_DIR/first-compile-pass42A.attribution.txt"
...
{
    echo "# TIM-142 first compile attempt -- pass 42A (wire SDL_Quit_Requested() into Main_Loop)"
    echo "# host: $(uname -srm)"
