...
LOG_FILE="$LOG_DIR/first-compile-pass40S.log"
SUMMARY_FILE="$LOG_DIR/first-compile-pass40S.summary.txt"
ATTRIB_FILE="$LOG_DIR/first-compile-pass40S.attribution.txt"
...
{
    echo "# TIM-103 first compile attempt -- pass 40S (LZWOTRAW.CPP deeper bug cluster)"
    echo "# host: $(uname -srm)"
