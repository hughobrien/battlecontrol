...
# linux/win32-stubs/dos.h, TIM-85 cluster).
#
...
#   pass 40F (TIM-85, this run)           : ???  (smoke +1 -> 275)
#
...
LOG_FILE="$LOG_DIR/first-compile-pass40F.log"
SUMMARY_FILE="$LOG_DIR/first-compile-pass40F.summary.txt"
ATTRIB_FILE="$LOG_DIR/first-compile-pass40F.attribution.txt"
...
{
    echo "# TIM-85 first compile attempt -- pass 40F (Win32 type/API stub bundle)"
    echo "# host: $(uname -srm)"
