...
#   S_FALSE  ((HRESULT)1L)
#
# IDirectDraw::RestoreDisplayMode was listed in TIM-74 in-scope but
...
# location, which TIM-74 explicitly forbids ("Stop & hand back if
...
# linux/win32-stubs/windows.h (TIM-74 cluster).
#
...
#   pass 37 (TIM-70)                      : 264
#   pass 38 (TIM-71)                      : 266
#   pass 39 (TIM-74, this run)            : ???  (expected 267-269)
#
...
LOG_FILE="$LOG_DIR/first-compile-pass39.log"
SUMMARY_FILE="$LOG_DIR/first-compile-pass39.summary.txt"
ATTRIB_FILE="$LOG_DIR/first-compile-pass39.attribution.txt"
...
{
    echo "# TIM-74 first compile attempt -- pass 39 (Win32 GDI/window-misc cluster shim)"
    echo "# host: $(uname -srm)"
